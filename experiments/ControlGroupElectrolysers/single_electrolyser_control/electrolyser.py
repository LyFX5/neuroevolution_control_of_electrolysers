...
class Electrolyser():
    def __init__(self, ID, delta_t):
        ...
        # self.__electrolyser_dynamical_state = {
        #     "power": self.getDinamics()[0] * self.maxPower,
        #     "state": self.getState(),
        #     "switch_num": self.getSwitchNum(),
        #     "run_out": self.getRunOut(),
        # }

    @property
    def electrolyser_dynamical_state(self):
        return {
    ...
    def get_state_on_step(self):
        return self.electrolyser_dynamical_state

    def step(self, control_signal):
        assert 60 <= control_signal <= 100 or control_signal == 0
        self.apply_control_signal_in_moment(control_signal / 100)
